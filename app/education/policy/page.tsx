...
import { Download, FileText, Lightbulb, Shield } from 'lucide-react';
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Standards for reporting safety incidents involving AI systems. These standards define what constitutes a reportable incident, reporting timelines, and required
                    information.
                  </p>
                  <div className="mt-2">
                    <Button variant="outline" size="sm" asChild>
