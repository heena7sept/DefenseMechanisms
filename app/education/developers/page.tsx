...
import { ArrowLeft, Code, Download, ExternalLink, Shield } from 'lucide-react';
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Testing specifically focused on multi-turn vulnerabilities, including goal hijacking, context manipulation, and instruction injection. Our simulator provides
                      a framework for this type of testing.
                    </p>
                    <div className="mt-2">
                      <Button variant="outline" size="sm" asChild>
                        <Link href="/simulator">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Develop a clear plan for responding to safety incidents. This includes procedures for investigating issues, implementing fixes, and communicating with
                      affected users.
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground mt-2">
