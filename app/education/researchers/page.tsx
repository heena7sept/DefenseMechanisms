              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Methodology for tracking changes in LLM safety over time, as models are updated and new safety measures are implemented. This helps identify trends and
                      evaluate progress.
                    </p>
                    <div className="mt-2">
                      <Button variant="outline" size="sm" asChild>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Standardized approach for comparing safety characteristics across different LLM architectures and implementations. This helps identify which approaches are
                      most effective.
                    </p>
                    <div className="mt-2">
                      <Button variant="outline" size="sm" asChild>
