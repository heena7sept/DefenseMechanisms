        ...
        <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0">
          ...
          <div className="flex flex-1 items-center justify-end space-x-4">
            <Button variant="ghost" size="sm" asChild>
              <Link href="/research" className="flex items-center gap-1">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Research methodologies, findings, and limitations should be transparently documented and shared with collaborators. We encourage open discussion of challenges
                    and uncertainties in the research process.
                  </p>
                </div>
                <div className="space-y-2">
